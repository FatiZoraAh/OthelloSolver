...
import com.othello.operations.Othellier;
import com.othello.operations.JeuControle;
import com.othello.operations.Deplacement;
import com.othello.operations.Position;
import com.othello.operations.Outils;
import com.othello.operations.JeuVue;
import com.othello.operations.OthellierListener;
...
public class Board extends JPanel implements OthellierListener, JeuVue, MouseMotionListener, MouseListener {
    ...
    private void init() {
        ...
        this.othellierBgCouleur = main.myColor;
    ...
    public void setControle(JeuControle gc) {
        this.init();
        this.controller = gc;
        this.ActPlayerCol = gc.getColJoueurAct();
    }

    public void jeuChangeNotif(JeuControle g) {
        this.ActPlayerCol = g.getColJoueurAct();
        this.repaint();
    }
    ...
    private void dessinerNoDepAlert(Graphics2D g2d, Rectangle2D r, String joueur) {
        ...
        String str = joueur + " NO MORE DEPLACEMENT...";
    ...
    private void dessinerDepValides(Graphics2D g2d, int rectLeft, int rectTop, int rectDimension) {
        ...
        int playerColour = this.ActPlayerCol;
    ...
    private void highlightSquare(int i, int j, Graphics2D g2d, int rectLeft, int rectTop, int rectDimension) {
        ...
        if (this.othellier != null) {
            List <Deplacement> moves = this.othellier.getDepValides(this.ActPlayerCol);
            Deplacement m = new Deplacement(i, j, this.ActPlayerCol);
    ...
    public void OthellierChangeNotif(Othellier b) {
        if (b.equals(this.othellier)) {
            this.ActPlayerCol = this.controller.getColJoueurAct();
            this.repaint();
        }
    }
